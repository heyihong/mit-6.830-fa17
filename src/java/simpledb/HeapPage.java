...
public class HeapPage implements Page {
    ...
    final Tuple tuples[];
    final int numSlots;
    TransactionId lastModifiedTxnId;
    ...
    public Iterator<Tuple> iterator() {
        return new Iterator<Tuple>() {
            ...
            public boolean hasNext() {
                for (; i < tuples.length && !isSlotUsed(i); i++);
